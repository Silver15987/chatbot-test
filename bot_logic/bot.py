...
class chat_bot:
    def __init__(self):
        ...
        self.intents = json.loads(open('bot_logic/intents.json').read())
        #load the training_data file which contains training data
        data=pickle.load(open("bot_logic/training_data","rb"))
        self.words=data['words']
        self.classes=data['classes']
        self.model=load_model('bot_logic/chatbot_model.h5')
    ...
    def response(self,sentence,userID='IB19G9'):
